...
N 410 -110 820 -110 {lab=VSS}
N 820 -110 830 -110 {lab=VSS}
...
N -0 -130 400 -130 {lab=VSS}
N 400 -130 400 -0 {lab=VSS}
N 350 0 400 0 {lab=VSS}
N 400 -0 400 120 {lab=VSS}
N 350 120 400 120 {lab=VSS}
N 400 -130 820 -130 {lab=VSS}
N 820 -130 820 -0 {lab=VSS}
N 770 0 820 0 {lab=VSS}
N 820 -0 820 360 {lab=VSS}
N 770 360 820 360 {lab=VSS}
N 770 240 820 240 {lab=VSS}
N 770 120 820 120 {lab=VSS}
...
N 450 -20 470 -20 {lab=B1}
N 450 -20 450 380 {lab=B1}
N 450 100 470 100 {lab=B1}
N 450 220 470 220 {lab=B1}
N 450 340 470 340 {lab=B1}
N 440 -40 470 -40 {lab=B2}
N 440 -40 440 380 {lab=B2}
N 440 320 470 320 {lab=B2}
N 440 200 470 200 {lab=B2}
N 440 80 470 80 {lab=B2}
C {libs/core_matchmaker/cdac_unit/cdac_unit_cell.sym} -200 0 0 0 {name=x1}
C {libs/core_matchmaker/cdac_unit/cdac_unit_cell.sym} 200 0 0 0 {name=x2}
C {libs/core_matchmaker/cdac_unit/cdac_unit_cell.sym} 200 120 0 0 {name=x3}
C {libs/core_matchmaker/cdac_unit/cdac_unit_cell.sym} 620 0 0 0 {name=x4}
C {libs/core_matchmaker/cdac_unit/cdac_unit_cell.sym} 620 120 0 0 {name=x5}
C {libs/core_matchmaker/cdac_unit/cdac_unit_cell.sym} 620 240 0 0 {name=x6}
C {libs/core_matchmaker/cdac_unit/cdac_unit_cell.sym} 620 360 0 0 {name=x7}
