...
| Cell | Purpose |
| --- | --- |
| `7D_matched_nmos_diffpair_4u` | Matched NMOS differential-pair reference |
| `7D_tg_switch` | Base transmission gate, NMOS 4 µm and PMOS 8 µm |
| `7D_tg_switch_nmos8u_pmos16u` | 2× transmission gate for the 2C bank |
| `7D_tg_switch_nmos16u_pmos32u` | 4× transmission gate for the 4C bank |
| `7D_tg_switch_nmos32u_pmos64u` | 8× transmission gate for the 8C bank |
| `7D_ref_sel_2to1` | VREF/VSS selector built from two transmission gates |
| `7D_ref_sel_2to1_nmos8u_pmos16u` | 2× selector for the 2C bank |
| `7D_ref_sel_2to1_nmos16u_pmos32u` | 4× selector for the 4C bank |
| `7D_ref_sel_2to1_nmos32u_pmos64u` | 8× selector for the 8C bank |
| `7D_cdac_unit_cell` | Legacy capacitor/selector unit cell |
...
| [`7D_cdac_4b_banked_scaled_selectors`](7D_cdac_4b_banked_scaled_selectors/7D_cdac_4b_banked_scaled_selectors_README.md) | Current 4-bit review reference with bank-weight-scaled selectors |

## Current CDAC hierarchy

All reusable MatchMaker cell names begin with the team identifier `7D_`. Testbench names use the corresponding `tb_7D_` prefix.
...
Each bit bank shares one `7D_ref_sel_2to1`-family selector. Selector transistor widths scale with the number of capacitors in the bank. This preserves comparable RC settling while reducing the top-level selector count from sixteen to four.
